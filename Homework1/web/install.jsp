    ...
    <body>
        ...
        <%
            ...
            String data[] = new String[]{
                ...
                //Videojoc (id, nom, videoconsola, disponibilitat, preuLloguer, descripcio, tipus, adrecaBotigues, botiga_id)
                "INSERT INTO " + schema + ".VIDEOJOC (id, nom, videoconsola, disponibilitat, preuLloguer, descripcio, tipus, adrecaBotigues, botiga_id) VALUES (NEXT VALUE FOR Videojoc_Gen, 'Super Mario Land', 'Game Boy', 1, 10.99, 'Clásico juego de plataformas', 'Plataforma', 'The Retro Games Store- pl. del Blat 3- Valls- 43800', 1)",
                "INSERT INTO " + schema + ".VIDEOJOC (id, nom, videoconsola, disponibilitat, preuLloguer, descripcio, tipus, adrecaBotigues, botiga_id) VALUES (NEXT VALUE FOR Videojoc_Gen, 'Quake', 'PC', 0, 15.99, 'Juego de acción en primera persona', 'Acción', 'Game Haven- Calle de Ejemplo 123- Ciudad- 12345', 1)",
                "INSERT INTO " + schema + ".VIDEOJOC (id, nom, videoconsola, disponibilitat, preuLloguer, descripcio, tipus, adrecaBotigues, botiga_id) VALUES (NEXT VALUE FOR Videojoc_Gen, 'The Legend of Zelda', 'Nintendo Entertainment System', 1, 12.99, 'Aventura épica', 'Aventura', 'Gamer Paradise- Av. Principal 456- Pueblo- 56789', 1)",
