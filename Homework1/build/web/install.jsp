    ...
    <body>
        ...
        <%
            ...
            String data[] = new String[]{
                ...
                "INSERT INTO " + schema + ".VIDEOJOC (id, nom, videoconsola, disponibilitat, preuLloguer, descripcio, tipus, adrecaBotigues) VALUES (NEXT VALUE FOR Videojoc_Gen, 'The Legend of Zelda', 'Nintendo Entertainment System', 1, 12.99, 'Aventura', 'Aventura', 'Gamer Paradise- Av. Principal 456- Pueblo- 56789')",
                ...
                "INSERT INTO " + schema + ".VIDEOJOC (id, nom, videoconsola, disponibilitat, preuLloguer, descripcio, tipus, adrecaBotigues) VALUES (NEXT VALUE FOR Videojoc_Gen, 'Brawl Stars', 'Nintendo Entertainment System', 0, 199.95, 'Juego de pelea', 'Lucha', 'Game Haven- Calle de Ejemplo 123- Ciudad- 12345')",
